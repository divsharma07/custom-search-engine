...
public class Configuration {
  ...
  public final static String W2G_FILE_NAME = "wt2g_inlinks.txt";
  public final static int PORT = 6379;
  public final static int DOCS_DB_1 = 5;
  public final static int SINK_DOCS_DB = 6;
  public final static String SINK_DOCS_LIST = "sinkDocs";
